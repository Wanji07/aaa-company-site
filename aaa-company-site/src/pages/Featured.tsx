    ...
    return(
        <>
            <div id="container" className="overflow-hidden p-8 relative z-60 bg-white w-full min-h-[65vh] overflow-hidden">
                ...
                <div className="relative mt-5 z-10 grid grid-cols-2 p-8 items-stretch">
                    <div id="rightSection" className="flex flex-col gap-8 justify-center">
                    <motion.h1 
                    ...
                    <div id="leftSection" className="flex justify-end items-stretch">
                        <img
                            src={AboutImage}
                            className="rounded-2xl h-full w-auto max-w-[80%] object-cover shadow-2xl ring-1 ring-black/10 hover:scale-[1.02] hover:shadow-3xl transition-transform duration-300 ease-out w-full max-w-[520px] sm:max-w-[600px] md:max-w-[680px] lg:max-w-[520px] aspect-[4/3]"
                        />
                    </div>
                </div>
            </div>

...
function Header() {
    ...
    return (
        <header className="bg-white absolute z-50 inset-x-0 flex items-center justify-between min-h-25 w-screen sm:bg-transparent" style={{padding: '18px 25px'}}>
                <img onClick={close} src={HeaderLogo} className="cursor-pointer max-w-[180px] p-1 h-auto" alt="AAA Navbar Logo" />
                    ...
                    <div id="mobileMenu" className="lg:hidden absolute top-full inset-x-0 z-40">
                        <div className="mx-3 mt-3 rounded-lg bg-neutral-900/90 backdrop-blur-md ring-1 ring-white/10 p-3">
                            <ul className="flex flex-col divide-y divide-white/10">
                                <li>
                                    <button onClick={close} className="w-full text-left px-4 py-3 text-white font-semibold hover:text-[#E61E25] transition">Home</button>
                                </li>
                                <li>
                                    <button onClick={close} className="w-full text-left px-4 py-3 text-white font-semibold hover:text-[#E61E25] transition">About Us</button>
                                </li>
                                <li>
                                    <button onClick={close} className="w-full text-left px-4 py-3 text-white font-semibold hover:text-[#E61E25] transition">Our Services</button>
                                </li>
                                <li className="pt-3">
                                    <button onClick={close} className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-[#E61E25] px-4 py-3 text-white font-semibold shadow-sm shadow-black/20 hover:bg-white hover:text-[#E61E25] transition">Contact Us</button>
                                </li>
                            </ul>
                        </div>
                    </div>
